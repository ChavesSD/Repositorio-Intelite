...
- **`frontend/src/data/treeData.js`** – Dados das árvores de **Tutoriais** e **APKs** (links e filhos).
- **`frontend/src/main.js`** – Entrada da aplicação e uso do Vuetify + Vue Router.
...
Para alterar links ou itens, edite `frontend/src/data/treeData.js` ou use a tela de **Admin**.
